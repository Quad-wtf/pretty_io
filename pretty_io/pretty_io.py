...
def PrintPretty(Style1: Optional[str] = None, Style2: Optional[str] = None,
...
def InputPretty(Prompt: Optional[str] = None, Style1: Optional[str] = None,
                Style2: Optional[str] = None, Color: Optional[str] = None,
                UserInputColor: Optional[str] = None, UserInputStyle: Optional[str] = None) -> str:
    """
...
def InputOutputPretty(Prompt: Optional[str] = None, Style1: Optional[str] = None,
                      Style2: Optional[str] = None, Color: Optional[str] = None,
                      UserInputColor: Optional[str] = None, UserInputStyle: Optional[str] = None,
                      ResponseText: Optional[str] = None, ResponseStyle: Optional[str] = None,
                      ResponseColor: Optional[str] = None) -> str:
    """
    ...
    """
    # Get the input
    user_input = InputPretty(Prompt, Style1, Style2, Color, UserInputColor, UserInputStyle)

    # Print response if provided
    if ResponseText:
        formatted_response = ResponseText.format(input=user_input)
        PrintPretty(Style1=ResponseStyle, Color1=ResponseColor, Print=formatted_response)
